        ...
        <section class="py-2">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                           <?php  $categories  = DB::table('categories')->get();  foreach ($categories  as $categorie )
                            {  $idcat=$categorie->id;  ?>  
                      ...
                      </div>   <span class="lead fw-normal text-black-50 mb-0 justify-content-center">Résultats pour :   <?php echo $search->libele; ?>
                  </span>
                    </div>
            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                  ...
                  <?php
                    $modal = DB::table('produits')->where('category_id',''.$search->id.'')->get();
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="{{ asset('img/' . $produit->image) }}" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{!! $produit->designation  !!}</h5>
                                    <!-- Product reviews-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".details<?php echo $produit->id;?>">Détails</button>
                                </div>
                            </div>
                        </div>
                    </div>
