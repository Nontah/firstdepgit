...
<div class="bg-gray-800 pt-3">
    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
        <h3 class="font-bold pl-2">   Enregistrement d'une nouvelle categorie </h3>
    </div>
</div>
              ...
              <div class="p-10 rounded-md shadow-md bg-white">
                  ...
                  <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-4 bg-gray-00">
                   ...
                   <div class="block mb-6">
                        ...
                        @enderror
                       <input name="libele" value="{{ old('libele') }}" type="text" class="border border-gray-500 @error('libele')border-red-500 @enderror rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-wider"/>
                  ...
                  <div class="block mb-6">
                        <span class="text-gray-700">Dèscription:</span>
                          ...
                          <small class="text-red-600">{{ $message }}</small>
                          @enderror 
                        <textarea type="text" class="form-textarea mt-1 block w-full rounded-lg  @error('description')border-red-500 @enderror rounded-md" name="description" id="description" rows="3" value=""> {{old('description')}}</textarea>
