...
window.delConfirm = function (formId) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    ...
    text: "Si vous le supprimé, vous ne serez plus en mesure de le récupérer !",
    //icon: 'warning',
...
window.delConfirm2 = function (formId) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    title: 'Êtes-vous sûr de vouloir supprimer cette categorie ?',
    text: "La suppréssion de cette catégorie entraine la suppréssion des produits liés à cette catégorie , et vous ne serez plus en mesure de les récupérer !",
    icon: 'warning',
    showCancelButton: true,
    confirmButtonColor: '#3085d6',
    cancelButtonColor: '#d33',
